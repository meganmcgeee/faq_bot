...
function prepHTML(options) {
  ...
  appendCSS(relative_path + "components/style/input.css");
  appendCSS(relative_path + "components/style/bot_says.css")
  appendCSS(relative_path + "components/style/user_says.css")
  appendCSS(relative_path + "components/style/window.css")
  appendCSS(relative_path + "components/style/typing.css")
